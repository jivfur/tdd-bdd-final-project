...
class TestProductModel(unittest.TestCase):
    ...
    def test_create_a_product(self):
        ...
        product = Product(name="Fedora", description="A red hat", price=12.50, available=True, category=Category.CLOTHS.name)
    ...
    def test_add_a_product(self):
        ...
        self.assertEqual(new_product.category.name, product.category.name)
    ...
    def test_read_product(self):
        ...
        # Creates a product and add it to the database
        products = Product.all()
        self.assertEqual(products, [])
        product = ProductFactory()
        product.id = None
        ...
        product_read = Product.find(product.id)
        self.assertEqual(product_read.name, product.name)
        self.assertEqual(product_read.description, product.description)
        self.assertEqual(product_read.price, product.price)
        self.assertEqual(product_read.available, product.available)
        self.assertEqual(product_read.category.name, product.category.name)

    def test_read_product_not_id(self):
        """ Test Reading when Id is None"""
        product = Product.find(None)
